...
tf.flags.DEFINE_integer('microbatches',241, 'Number of microbatches '
                        '(must evenly divide batch_size)')
    ...
    def __init__(self, dataset, parameters):
        ...
        if parameters['use_crf']:
            with tf.variable_scope("crf") as vs:
                ...
                print("Salman, unary_scores_expanded dim= {} and {} and {}".format(unary_scores_expanded.shape,input_label_indices_flat_batch.shape,sequence_lengths.shape))
...
#        grads_and_vars = self.optimizer.compute_gradients(self.losses)
